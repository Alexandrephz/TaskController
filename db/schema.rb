...
ActiveRecord::Schema[7.0].define(version: 2023_05_13_185313) do
  ...
  create_table "task_users", id: false, force: :cascade do |t|
    t.bigint "task_id"
    t.bigint "user_id"
    t.index ["task_id", "user_id"], name: "index_task_users_on_task_id_and_user_id"
  ...
  create_table "tasks_roles", id: false, force: :cascade do |t|
    t.bigint "task_id"
    t.bigint "role_id"
    t.index ["role_id"], name: "index_tasks_roles_on_role_id"
    t.index ["task_id", "role_id"], name: "index_tasks_roles_on_task_id_and_role_id"
    t.index ["task_id"], name: "index_tasks_roles_on_task_id"
  end
